...
* 
* Javascript cryptoPost object.
* Client-side encryption/decryption for cryptoPost.class.php
* 
* Uses Gibberish-AES javascript library from Mark Percival <mark@mpercival.com>
* Uses jsbn/RSA javascript library from Tom Wu <tjw@cs.Stanford.EDU>
* 
* ver. 1.01:    Now detect changes in public RSA key and generates new AES key.
*/
var cryptoPost = {
    aeskey: null,
    aeskeyElement: null,
    ...
    init: function()
    {
        ...
        if (sessionStorage.getItem("aesk") === null){
            ...
            this.aeskeyElement.name = 'cryptoPost_key';
